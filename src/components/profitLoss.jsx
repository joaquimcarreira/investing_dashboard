...
import { PieChart, Pie, ResponsiveContainer, FunnelChart, Funnel, Cell, YAxis, CartesianGrid, BarChart, Bar, XAxis } from 'recharts';
...
function ProfitLoss(props) {
    ...
    return (
        <Box style={{ height: "110vh", maxWidth: "1168px", paddingTop: "40px" }} id="profitloss">
            <Typography
                variant={"h6"}
