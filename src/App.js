    ...
    <ThemeProvider theme={theme}>
      <BrowserRouter>
        <div className={classes.container}>
          ...
          <Drawer props={{ open, setOpen, ...props }}></Drawer>
          <Main
            open={open}
            sx={{
              height: "100%",
          ...
          >
            ...
            <Route
              exact
              path="/kpi"
              component={(props) => <Kpi kpiData={kpiData}></Kpi>}
            ></Route>
            <Route
              exact
              path="/profitloss"
              component={(props) => <ProfitLoss plData={plData}></ProfitLoss>}
            ></Route>
            <Route exact path="/cfo"></Route>
            <Route
              exact
              path="/finperformance"
              component={(props) => (
